...
There are functions to inspect flag variables and manage the set of flag variables in a
CNGI Dataset. Other functions calculate flags using different flagging methods.
"""
...
#from .flagmanager_list import flagmanager_list
