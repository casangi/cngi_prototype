...
def dirty_image(vis_dataset, grid_parms):
      ...
      assert grid_parms_dirty_image['chan_mode'] == 'continuum' or  grid_parms_dirty_image['chan_mode'] == 'cube','The chan_mode parameter in grid_parms can only be \'continuum\' or \'cube\'.'
      ...
      uncorrected_dirty_image = uncorrected_dirty_image.real * (grid_parms_dirty_image['imsize'][0] * grid_parms_dirty_image['imsize'][1])
      ...
      dirty_image_dict = {}
      coords = {'u':np.arange(grid_parms_dirty_image['imsize'][0]),'v':np.arange(grid_parms_dirty_image['imsize'][1]),'chan':freq_coords, 'pol':np.arange(n_imag_pol)}
