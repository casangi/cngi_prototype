...
def summarizeDF(df, field=None, spw=None, timerange=None, uvrange=None, antenna=None, scan=None):
    """
    Calculate and return descriptive statistics of an MS Dataframe

    .. note::
        This implementation still needs a defined output dictionary format

    .. warning::
        The runtime of this function is currently impractically long for even medium-sized measurement sets generated by ms_to_pq
