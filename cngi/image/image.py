...
def rebin(ds, **kwargs):
    ...
    .. note::
        This implementation still needs to check for and apply all masks and regions, accept arguments that control which DataArray is binned, and improve performance when framework client has processes=True

    .. warning::
        The new Dataset generated by this function will lose its attributes. See https://github.com/pydata/xarray/issues/3376
