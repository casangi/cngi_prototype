...
def processDDI(ddi, infile, outfile, compressor):
    ...
    # start = time.time()
    n_time, n_ant, n_baseline, time_step, time_step_indx, n_baseline_per_timestep, auto_corr_flag, baseline_mat, baseline_ant_pairs, ant1_col, ant2_col = time_baseline_info(
        ms_ddi, n_row)
